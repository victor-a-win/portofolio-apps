export default function Task() {
    return (
        <div className="Task">
            <div>
            <br />
            <a className="no-underline hover:underline text-orange-700 pl-0 text-base sm:text-xl"
                >Task</a>    
            </div>
            ...
            <div className="grid grid-flow-col grid-cols-3 grid-rows-1 gap-4">
                <div>
                    <img className="sw-[100px] h-[65px] sm:w-[320px] sm:h-[200px] rounded-lg" src="front-end.webp" alt="FrontEnd-Activites" />
                </div>
                <div>
                    <img className="w-[100px] h-[65px] sm:w-[320px] sm:h-[200px] rounded-lg" src="front-end2.webp" alt="FrontEnd-Activities-2" />
                </div>
                <div>
                    <img className="w-[100px] h-[65px] sm:w-[320px] sm:h-[200px] rounded-lg" src="back-end.webp" alt="BackEnd-Activities" />
                </div>
            </div>
        </div>
    );
