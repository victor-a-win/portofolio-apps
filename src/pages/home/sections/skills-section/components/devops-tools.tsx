    ...
    return (
        <div className="DevOps & Tools">
            <div className="flex justify-center sm:flex sm:justify-center">
                ...
                >
                     <span>
                        <span className="absolute inline-flex h-[10px] w-[10px] left-[50px] sm:h-[16px] sm:w-[16px] animate-ping rounded-full bg-orange-400 opacity-75"></span>
                        <img className="size-14 sm:size-28 sm:ml-2 sm:mt-2" src="docker_logo.png" alt="Docker-Logo" />
                    </span>
            ...
            <div className="flex justify-center sm:flex sm:justify-center">
                <div className="Box-Skill4 border-2 border-orange-500 w-[70px] h-[74px] mt-6 mr-2 pr-2 pt-1 rounded-xl shadow-md
                                sm:w-[140px] sm:h-[144px] sm:mr-5 sm:mt-10"
                >
                    <img className="size-14 sm:size-28 sm:ml-1 sm:mt-2" src="AWS_Server.png" alt="AWS_Logo" />
                ...
                >
                     <span>
                        <span className="absolute inline-flex h-[10px] w-[10px] sm:h-[16px] sm:w-[16px] left-[50px] animate-ping rounded-full bg-orange-400 opacity-75"></span>
                        <img className="size-14 sm:size-28 sm:ml-2 sm:mt-2" src="vercel.svg" alt="Vercel-Logo" />
                    </span>
