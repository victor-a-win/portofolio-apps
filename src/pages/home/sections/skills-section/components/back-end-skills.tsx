        ...
        <div className="Back-End Skills">
            <div className="flex justify-evenly sm:flex sm:justify-center">
                ...
                >
                    ...
                    <div className="pl-2 text-[8px] sm:text-[14px] sm:pl-8 font-bold">Node JS</div>
                </div>
                ...
                >
                    <span>
                        ...
                        <img className="size-14 sm:size-28 sm:ml-2 sm:mt-2" src="express-svgrepo-com.svg" alt="Express-Logo" />
                    </span>
