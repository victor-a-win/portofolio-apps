    ...
    return (
            <div className="flex justify-evenly sm:flex sm:justify-center">
                <div className="Box-Skill1 border-2 border-orange-500 w-[70px] h-[74px] pl-1 rounded-xl shadow-md
                    ...
                    <img className="size-14 mt-1 sm:size-28 sm:ml-2 sm:mt-2" src="HTML5_CSS3_Logos.png" alt="HTML-CSS-Logo" />
                ...
                >
                    <span>
                        <span className="absolute inline-flex h-[10px] w-[10px] sm:h-[16px] sm:w-[16px] right-6 sm:mr-72 animate-ping rounded-full bg-orange-400 opacity-75"></span>
                        <img className="size-14 mt-1 sm:size-28 sm:ml-1 sm:mt-2 " src="ReactJS.png" alt="ReactJS-Logo" />
                    </span>
